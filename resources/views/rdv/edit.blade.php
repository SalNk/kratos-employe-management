                ...
                <div class="col-12 col-md-8">
                    <div class="app-card app-card-settings shadow-sm p-4">
                        ...
                        <div class="app-card-body">
                            <form class="settings-form" action={{ route('rdv.update', $rdv->id) }} method="PUT">
                                @csrf
                                @method('PUT')
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="setting-input-1"
                                            placeholder="Saisir le Nom" name="title" value={{ $rdv->title }}>
                                        @error('title')
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" class="form-control" id="setting-input-3"
                                            placeholder="Saisir le mail" name="date" value={{ $rdv->date }}>
                                        @error('date')
                                            <p class="text-danger" style="font-size: 13px;">{{ $message }}</p>
                                        @enderror
                                    </div>
