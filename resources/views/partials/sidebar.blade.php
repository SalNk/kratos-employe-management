 <div id="app-sidepanel" class="app-sidepanel">
     ...
     <div class="sidepanel-inner d-flex flex-column">
         ...
         <div class="app-branding">
             <a class="app-logo" href="#"><span class="logo-text">Gestion d'employes</span></a>
             ...
             <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                     ...
                     <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                         <ul class="submenu-list list-unstyled">
                             <li class="submenu-item">
                                 <a class="submenu-link" href={{ route('employe.index') }}>Liste</a>
                             </li>
                             <li class="submenu-item">
                                 <a class="submenu-link" href={{ route('employe.create') }}>Ajouter</a>
                             </li>
                         </ul>
                     </div>
                 </li><!--//nav-item-->
                 <li class="nav-item has-submenu">
                     ...
                     <div id="submenu-3" class="collapse submenu submenu-3" data-bs-parent="#menu-accordion">
                         <ul class="submenu-list list-unstyled">
                             <li class="submenu-item">
                                 <a class="submenu-link" href={{ route('rdv.index') }}>Liste</a>
                             </li>
                             <li class="submenu-item">
                                 <a class="submenu-link" href={{ route('rdv.create') }}>Ajouter</a>
                             </li>
                         </ul>
                     </div>
                 </li><!--//nav-item-->
                 <li class="nav-item has-submenu">
                     ...
                     <a class="nav-link submenu-toggle" href="#" data-bs-toggle="collapse"
                         ...
                         <span class="nav-link-text">Salaire</span>
                         <span class="submenu-arrow">
                             <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-chevron-down"
                                 fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                 <path fill-rule="evenodd"
                     ...
                     <div id="submenu-4" class="collapse submenu submenu-4" data-bs-parent="#menu-accordion">
                         <ul class="submenu-list list-unstyled">
                             <li class="submenu-item">
                                 <a class="submenu-link" href={{ route('salaire.index') }}>Liste</a>
                             </li>
                             <li class="submenu-item">
                                 <a class="submenu-link" href={{ route('salaire.create') }}>Ajouter</a>
                             </li>
                         </ul>
                     </div>
                 </li><!--//nav-item-->
